...
export function notFoundError(req, res, next) {
   ...
   /* * gestionnaire d'erreurs avec quatre paramètres :
     * Le premier paramètre est supposé être une erreur transmise par *le "next" d'un autre middleware 
    *le "next" d'un autre middleware
   
   */
    
    export function errorHandler(err, req, res, next) { // Renvoyer à l'utilisateur le code et le message de l'erreur 
